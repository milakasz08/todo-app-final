...
class RentalController extends AbstractController
{
     ...
     * Approve a rental.
     *
     * @param Rental                 $rental        wypozyczenie do zatwierdzenia     * @param EntityManagerInterface $entityManager menedzer encji Doctrine     *
     ...
     * Reject a rental.
     *
     * @param Rental                 $rental        wypozyczenie do odrzucenia     * @param EntityManagerInterface $entityManager menedzer encji Doctrine     *
     * @return Response przekierowanie do listy wypozyczen     */
     ...
     *
     * @param Rental                 $rental        wypozyczenie do zwrotu     * @param EntityManagerInterface $entityManager menedzer encji Doctrine     *
     * @return Response przekierowanie do listy wypozyczen     */
